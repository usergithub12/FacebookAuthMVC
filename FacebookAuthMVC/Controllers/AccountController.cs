...
using FacebookAuthMVC.Models;
using Facebook;
using System.Configuration;

namespace FacebookAuthMVC.Controllers
{
    [Authorize]
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> ExternalLoginCallback(string returnUrl)
        {
           ...
           // dynamic userInfo = new FacebookClient(accessToken).Get("/me?fields=email,first_name,last_name");
            dynamic userInfo = new FacebookClient(accessToken).Get("/me?fields=email,first_name,last_name,gender,birthday,hometown");
            ...
            string hometown = userInfo["hometown"].name;
                ...
                default:
                    ...
                    return View("ExternalLoginConfirmation",
                        new ExternalLoginConfirmationViewModel {
                            UserName = firstname + " " + lastname, //loginInfo.DefaultUserName,
